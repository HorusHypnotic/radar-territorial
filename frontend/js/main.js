...
async function boot() {
  const [data, zones, points, health, remoteKpis] = await Promise.all([fetchJson(["/api/data", "../data/output/dashboard_data.json"], { zonas: [], obras: [], fornecedores: [] }), fetchJson(["/api/geojson/zonas", "../data/output/zonas_poligonos.geojson", "data/zonas_redencao.geojson"], EMPTY_GEOJSON), fetchJson(["/api/geojson/pontos", "../data/output/radar_geojson.geojson"], EMPTY_GEOJSON), fetchJson(["/api/health"], null), fetchJson(["/api/kpis"], null)]);
